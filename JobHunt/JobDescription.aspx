            ...
            <div class="row">
               <div class="col-md-8">
                  ...
                  <%--<h4>Company Name</h4>
                   ...
                   <p>Gulshan 1</p>
                   <h4>Job Description:</h4>
                   <p>Lorem ipjusto, tristique scelerisque est viverra nec.</p>
                   <h4>Experience Requirements:</h4>
                   <p>3/4 years experience will get preference</p>
                   ...
                   <%--<form class="btn-toolbar">
                    <div class="form-group row" style="margin-top: 10px;">
                       <div class="col-sm-10">
                          <asp:Button ID="Button3" runat="server"  class="btn btn-warning badge-pill" Text="Apply" style="width: 80px;" OnClick="apply" />
                       </div>
                   </div>
                    </form>--%>
